        ...
        child: Column(
          children: [
            ...
            _buildSection(
              title: 'Data Diri',
              children: [
                _buildField(label: 'Nama Lengkap', value: 'Faldy Ardiansyah', icon: Icons.person_outline),
                _buildField(label: 'Email', value: 'faldy@gmail.com', icon: Icons.email_outlined),
                _buildField(label: 'Nomor Telepon', value: '+62 812 3456 7890', icon: Icons.phone_outlined),
              ],
            ),
            ...
            _buildSection(
              title: 'Alamat',
              children: [
                _buildField(label: 'Kota', value: 'Jakarta Selatan', icon: Icons.location_city_outlined),
                _buildField(label: 'Provinsi', value: 'DKI Jakarta', icon: Icons.map_outlined),
              ],
            ),
            const SizedBox(height: 24),
            SizedBox(
