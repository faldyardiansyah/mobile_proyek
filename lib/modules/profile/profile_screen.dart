    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return RefreshIndicator(
          onRefresh: () => profileCtrl.loadUserData(),
          child: Skeletonizer(
            enabled: isLoading,
            effect: const ShimmerEffect(duration: Duration(milliseconds: 2000)),
            child: Column(
              children: [
                  ...
                  child: Stack(
                    children: [
                      CircleAvatar(
                        ...
                        backgroundImage:
                            (!isLoading &&
                                authC.user.value['profile_photo_url'] != null &&
                                authC.user.value['profile_photo_url']
                                    .toString()
                                    .isNotEmpty)
                            ? NetworkImage(
