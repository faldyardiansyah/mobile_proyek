...
class AuthController extends GetxController{
  ...
  Future<void> login()async{
    ...
    try {
      ...
      Get.snackbar('Berhasil', 'Selamat datang ${response.data['user']['nama']}',
      ...
      final message = e.response?.data?['message'] ?? 'Login gagal, silakan coba lagi';
  ...
  Future<void> register() async {
    if (namaRegisterController.text.isEmpty || registerEmailController.text.isEmpty || registerPasswordController.text.isEmpty) {
    ...
    if (!isAgreeTerms.value) {
      Get.snackbar('Perhatian', 'Anda harus menyetujui syarat dan ketentuan',
        backgroundColor: Colors.orange.shade50,
        colorText: Colors.orange.shade800,
        snackPosition: SnackPosition.TOP,
        margin: const EdgeInsets.all(16),
    ...
    if (registerPasswordController.text.length < 6) {
      Get.snackbar('Perhatian', 'Password harus minimal 6 karakter',
        backgroundColor: Colors.orange.shade50,
        colorText: Colors.orange.shade800,
        snackPosition: SnackPosition.TOP,
        margin: const EdgeInsets.all(16),
    ...
    try {
      ...
      final message = e.response?.data?['message'] ?? 'Registrasi gagal, silakan coba lagi';
